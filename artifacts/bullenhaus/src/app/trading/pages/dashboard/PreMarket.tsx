    ...
    <div className="glass-card border-accent-primary/20 relative overflow-hidden group flex flex-col">
      ...
      <div className="p-8 relative z-10 flex flex-col flex-1">
        ...
        <div className="text-right">
          ...
          <p className="text-3xl font-mono font-bold text-white">${Number(asset.price).toFixed(2)}</p>
        </div>
      </div>
      ...
      <div className="space-y-6 mt-auto">
        ...
        >
          {isBuyingItem ? (
            <span className="animate-pulse">{t('premarket.processing')}</span>
          ) : (
            <>
