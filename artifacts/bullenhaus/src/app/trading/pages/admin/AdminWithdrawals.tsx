      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="font-serif text-2xl font-light italic tracking-tight text-text flex items-center gap-3">
            <Upload className="text-warning" size={22} /> Withdrawal Requests
          </h2>
          <p className="text-sm text-text-muted mt-1">Review and process outgoing withdrawal requests.</p>
        </div>
                ...
                <td colSpan={7}>
                  <div className="flex flex-col items-center justify-center py-16 gap-3">
                    ...
                    <p className="text-sm font-medium text-text-muted">
                      {loading ? 'Loading withdrawals...' : 'No withdrawal requests'}
                    </p>
                  </div>
                </td>
              </tr>
