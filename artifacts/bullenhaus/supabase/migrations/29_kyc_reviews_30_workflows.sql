-- ============================================================
-- Migration 29: KYC Reviews — CRM-side compliance workflow
-- Extends existing users.kyc_status + users.kyc_documents
-- ============================================================
...
CREATE POLICY "compliance_can_insert_kyc_reviews" ON public.kyc_reviews
...
CREATE POLICY "compliance_can_update_kyc_reviews" ON public.kyc_reviews
  FOR UPDATE TO authenticated
  USING (EXISTS (SELECT 1 FROM public.users u WHERE u.id = auth.uid()
    AND u.role IN ('admin','trade_admin','crm_admin','manager','director')));

-- ============================================================
-- Migration 30: Workflow Rules + Executions
-- ============================================================
